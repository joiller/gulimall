...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, order_num) VALUES (27, 1, '参数管理', 'sys/com.joiller.gulimall.common.config', 'sys:com.joiller.gulimall.common.config:list,sys:com.joiller.gulimall.common.config:info,sys:com.joiller.gulimall.common.config:save,sys:com.joiller.gulimall.common.config:update,sys:com.joiller.gulimall.common.config:delete', 1, 'com.joiller.gulimall.common.config', 6);
